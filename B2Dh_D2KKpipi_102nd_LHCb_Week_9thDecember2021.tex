...
\section{Summary and conclusion of $KK\pi\pi$ analysis}
\begin{frame}{Summary and conclusion of $KK\pi\pi$ analysis}
  \begin{center}
    {\huge Summary and conclusion of \\$KK\pi\pi$ analysis}
  \end{center}
\end{frame}
...
\begin{frame}{Global mass fit of $B^\pm\to Dh^\pm$, $D\to\pi^+\pi^-\pi^+\pi^-$}
  ...
  \vspace{-0.5cm}
  \begin{itemize}
    \item{Total yields are consistent with $KK\pi\pi$}
  \end{itemize}
\end{frame}
